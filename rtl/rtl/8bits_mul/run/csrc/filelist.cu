...
ARCHIVE_OBJS=
ARCHIVE_OBJS += _81633_archive_1.so
_81633_archive_1.so : archive.1/_81633_archive_1.a
	@$(AR) -s $<
	@$(PIC_LD) -shared  -Bsymbolic  -o .//../simv.daidir//_81633_archive_1.so --whole-archive $< --no-whole-archive
	@rm -f $@
	@ln -sf .//../simv.daidir//_81633_archive_1.so $@
